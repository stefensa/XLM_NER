...
class Trainer(object):
    ...
    def __init__(self, data, params):
        ...
        params.mask_scores = np.maximum(counts, 1) ** -params.sample_alpha    #maximum() 逐位比较，取最大值
    ...
    def mask_out(self, x, lengths):
        ...
        if params.sample_alpha == 0:
            ...
            n_tgt = math.ceil(params.word_pred * slen * bs)   # math.ceil 上入整数
            # param.word_pred 要预测的词占总量的比值
